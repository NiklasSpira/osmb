  ...
  getPictures() {
    return [
      ...
      },
      {
        id: 6,
        name: 'Picture 6',
        url: 'https://picsum.photos/250/250?random=6',
        description: 'A random shot of wildlife in its natural habitat.',
      },
      {
        id: 7,
        name: 'Picture 7',
        url: 'https://picsum.photos/250/250?random=7',
        description:
      ...
      },
      {
        id: 14,
        name: 'Picture 14',
        url: 'https://picsum.photos/250/250?random=14',
        description:
      ...
      },
      {
        id: 18,
        name: 'Picture 18',
        url: 'https://picsum.photos/250/250?random=18',
        description: 'A random shot of a bustling market with vibrant colors.',
      },
      {
        id: 19,
        name: 'Picture 19',
        url: 'https://picsum.photos/250/250?random=19',
        description:
      ...
      },
      {
        id: 20,
        name: 'Picture 20',
        url: 'https://picsum.photos/250/250?random=20',
      ...
      },
      {
        id: 24,
        name: 'Picture 24',
        url: 'https://picsum.photos/250/250?random=24',
        description: 'A random capture of a desert landscape with sand dunes.',
      },
      {
        id: 25,
        name: 'Picture 25',
        url: 'https://picsum.photos/250/250?random=25',
        description:
      ...
      },
      {
        id: 40,
        name: 'Picture 40',
        url: 'https://picsum.photos/250/250?random=40',
        description:
      ...
      },
      {
        id: 44,
        name: 'Picture 44',
        url: 'https://picsum.photos/250/250?random=44',
        description: 'A random capture of a serene desert landscape.',
      },
      {
        id: 45,
        name: 'Picture 45',
        url: 'https://picsum.photos/250/250?random=45',
        description: 'A random photograph of a snowy mountain peak.',
      },
      {
        id: 46,
        name: 'Picture 46',
        url: 'https://picsum.photos/250/250?random=46',
        description: 'A random shot of a vibrant street festival.',
      },
      {
        id: 47,
        name: 'Picture 47',
        url: 'https://picsum.photos/250/250?random=47',
        description: 'A random image of a serene meadow with wildflowers.',
      },
      {
        id: 48,
        name: 'Picture 48',
        url: 'https://picsum.photos/250/250?random=48',
        description: 'A random capture of a historic castle on a hill.',
      },
      {
        id: 49,
        name: 'Picture 49',
        url: 'https://picsum.photos/250/250?random=49',
        description: 'A random photograph of a bustling city street.',
      },
      {
        id: 50,
        name: 'Picture 50',
        url: 'https://picsum.photos/250/250?random=50',
        description: 'A random shot of a tranquil beach at sunset.',
      },
    ];
  }
